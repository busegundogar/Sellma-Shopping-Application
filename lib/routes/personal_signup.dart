...
class PersonalSignUp extends StatefulWidget{
  const PersonalSignUp({Key? key, required this.analytics, required this.observer}) : super(key: key);
  ...
  @override
  _PersonalSignUp createState() => _PersonalSignUp();
}

class _PersonalSignUp extends State<PersonalSignUp> {
                          ...
                          child: OutlinedButton(
                            onPressed: () {
                              if(_formKey.currentState!.validate()) {
                                ...
                                auth.signupWithMailAndPass(mail, password, personName);
